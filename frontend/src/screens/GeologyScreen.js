...
export default function GeologyScreen() {
  return (
    <div>
      <Helmet>
        <title>Geologic Area Map Order</title>
        <meta name="description" content="Place an order for a Geologic Map of All places in Nigeria and your order will be available less than 24 hours" />
