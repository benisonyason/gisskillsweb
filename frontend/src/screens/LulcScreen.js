...
export default function LulcScreen() {
  return (
    <div>
      <Helmet>
        <title>LULC Order</title>
        <meta name="description" content="Place an order for a Land use/Land cover Map of All places in Nigeria and your order will be available less than 24 hours" />
