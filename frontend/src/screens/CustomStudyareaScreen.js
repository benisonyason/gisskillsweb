...
export default function CustomStudyareaScreen() {
  return (
    <div>
      <Helmet>
        <title>Study Area Order</title>
        <meta name="description" content="Place an order for a Study Area Map of All places in Nigeria and your order will be available less than 24 hours" />
        <link rel="canonical" href="/studyarea" />
      </Helmet>
      ...
      <form className='form' action='https://docs.google.com/forms/u/0/d/e/1FAIpQLSflNbyhbvtN2ZxIs-9AFcWsdiP2lJCflhhok_IFvEzhq5q-gg/formResponse'>
        ...
        <div>
          <label>Study Area Map location</label>
