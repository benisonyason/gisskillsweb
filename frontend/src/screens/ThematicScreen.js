...
export default function ThematicScreen() {
  return (
    <div>
      <Helmet>
        <title>Thematic Map Order</title>
        <meta name="description" content="Place an order for a Thematic Map of All places in Nigeria and your order will be available less than 24 hours" />
