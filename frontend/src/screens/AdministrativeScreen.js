...
export default function AdministrativeScreen() {
  return (
    <div>
      <Helmet>
        <title>Admin Area Order</title>
        <meta name="description" content="Place an order for a Administrative Map of All places in Nigeria and your order will be available less than 24 hours" />
      ...
      <form className='form' action='https://docs.google.com/forms/u/0/d/e/1FAIpQLSflNbyhbvtN2ZxIs-9AFcWsdiP2lJCflhhok_IFvEzhq5q-gg/formResponse'>
        <div>
          <h1>Administrative Area Map Order</h1>
