...
export default function SoilScreen() {
  return (
    <div>
      <Helmet>
        <title>Soil Map Order</title>
        <meta name="description" content="Place an order for a Soil Map of All places in Nigeria and your order will be available less than 24 hours" />
