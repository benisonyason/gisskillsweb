...
export default function VegetationScreen() {
  return (
    <div>
      <Helmet>
        <title>Vegetation Map Order</title>
        <meta name="description" content="Place an order for a Vegetation Map of All places in Nigeria and your order will be available less than 24 hours" />
        <link rel="canonical" href="/vegetation" />
      </Helmet>
